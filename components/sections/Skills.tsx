...
export function Skills() {
  return (
    <section id="skills" className="relative py-24 overflow-hidden bg-[var(--section-bg)]">
      {/* ⭐ Star field */}
      ...
      <div className="relative z-10 mx-auto w-full px-4">
        ...
        <div className="rounded-3xl border border-[var(--card-border)] bg-[var(--card-bg)] p-8 shadow-sm">
